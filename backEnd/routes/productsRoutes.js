...
const { getAllProducts, createProduct, updateProduct, DeleteProduct, getSingleProduct, addReview, getReview, deleteReview, getTopSellingProducts, getAllCategories } = require('../controllers/productController.js');
